...
def check():
        ...
        if name ==cor_name and password == cor_password :
            ...
            if name != "" or password != "" :
                ...
                check_label.config(text ="You Didn't Write Anything ")
...
login_button = tk.Button(root, text = "Login", command = check)
login_button.place(x=220, y= 160)



check_label = tk.Label(root)
check_label.place(x= 230, y = 10)
