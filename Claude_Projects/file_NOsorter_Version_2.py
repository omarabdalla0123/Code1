...
TAG_RULES = [
    {"label": "(PT)", "tag": "(PT)", "folder": "product tamples", "color": "#2563EB", "light": "#EFF6FF"},
    {"label": "(CF)", "tag": "(CF)", "folder": "CF_Files",         "color": "#059669", "light": "#ECFDF5"},
]
...
def make_card(parent, rule, badge_text):
    ...
    lb = tk.Listbox(lb_frame, font=("Segoe UI", 9), height=4,
